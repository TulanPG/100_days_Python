...
Stock_API_key = "HQJW9AOMV40745IS"
...
stock_data_date = stock_data["Meta Data"]["3. Last Refreshed"]
stock_data_close = stock_data["Time Series (5min)"][stock_data_date]["4. close"]
